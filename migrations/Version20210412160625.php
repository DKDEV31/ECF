 ...
 */
final class Version20210412160625 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE request_delete (id INT AUTO_INCREMENT NOT NULL, banker_id INT NOT NULL, client_id INT NOT NULL, account_id INT DEFAULT NULL, state VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, close_request VARCHAR(255) NOT NULL, INDEX IDX_714BBF7C38835980 (banker_id), INDEX IDX_714BBF7C19EB6921 (client_id), UNIQUE INDEX UNIQ_714BBF7C9B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
